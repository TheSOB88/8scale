...
scale = Scale( [ 80, 240, 400, 560, 720, 880, 1040, 1200 ], [0, 160, 320, 480, 640, 800, 960, 1120 ] )
scale = Scale( [0, 199.52, 399.52, 500.02, 699.32, 899.13, 1099.49 ], [ 0, 100.04, 299.8, 500.02, 599.95, 799.51, 999.54 ] )
i = 11/12
scale = Scale( [ 0, 200 * i, 400 * i, 500 * i, 700 * i, 900 * i, 1100 * i, 1100 ] )
i, j = 725/700, 700/725
#scale = Scale( [ 0, 200 * i, 400 * i, 500 * i, 725, 725 + 200 * j, 725 + 400 * j ] )
s = [ 0, 3.83/7 * 498, 498, 10.83/7 * 498, 498*2, 1200 ]
d = []
...
scale = Scale( [ 0, 120, 240, 360, 480, 600, 720, 840, 960, 1080 ] )
scale = Scale( [ 0, 211.76, 388.24, 494.11, 705.88, 882.35, 1094.12 ],
               [ 0, 105.88, 317.64, 494.11, 600, 811.76, 988.24 ] )
scale = Scale( [ 0, 125, 250, 375, 500, 702, 827, 952, 1102 ],
               [ 75, 200, 325, 450, 575, 777, 902, 1027, 1177 ] )
